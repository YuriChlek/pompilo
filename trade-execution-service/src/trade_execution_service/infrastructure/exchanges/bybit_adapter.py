...
class BybitExecutionAdapter:
    """Placeholder Bybit adapter.

    This class defines the exchange boundary only. It must not place orders until private
    credentials, permissions, idempotency, venue constraints, and audit persistence are
    implemented.
    """
    ...
    async def execute(self, *, account: ExecutionAccountRef, intent: ExecutionIntent) -> ExecutionDecision:
        return ExecutionDecision(
            ...
            reason="bybit_order_placement_not_implemented",
